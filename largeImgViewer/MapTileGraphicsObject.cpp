...
QSharedPointer<TileSource> MapTileGraphicsObject::tileSource() const
{
    return _tileSource;
}

void MapTileGraphicsObject::setTileSource(QSharedPointer<TileSource> nSource)
{
    ...
    //Set the new source
    QSharedPointer<TileSource> oldSource = _tileSource;
    _tileSource = nSource;
